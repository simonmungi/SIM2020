...
namespace WindowsFormsApp1
{
    public class Generador
    {
        ...
        public Generador(int n, Estrategia est)
        {
            this.estrategia = est;
            this.numeros = est.generarNumeros(n);
            this.cantidad = n;
        }

        //calculo maximos y minimos
        public double[] calcularExtremos(List<double> numeros)
        {
            double max = 0.0d;
            double min = 1.0d;
            ...
            {
                double num = numeros.ElementAt(i);
                if (num >= max) { max = num; }
        ...
        public double calcularMedia()
        {
            ...
            this.media = Math.Round(acum / cantidad, 4);
        ...
        public double calcularVarianza()
        {
            ...
            this.varianza = Math.Round(acum / cantidad,4);
            return varianza;
        }
